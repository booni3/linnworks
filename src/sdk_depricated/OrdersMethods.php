...
class OrdersMethods
{
    ...
    {
        return json_decode(Factory::GetResponse("Orders/GetOpenOrders",
            array(
    ...
    {
        return json_decode(Factory::GetResponse("Orders/GetAllOpenOrders",
            array(
                "filters" => $filters,
                "sorting" => $sorting,
                "fulfilmentCenter" => $fulfilmentCenter,
    ...
    {
        return json_decode(Factory::GetResponse("Orders/GetOrdersById",
            array(
    ...
    {
        return json_decode(Factory::GetResponse("Orders/MoveToLocation",
            array(
    ...
    {
        return json_decode(Factory::GetResponse("Orders/ChangeShippingMethod",
            array(
                "orderIds" => json_encode($orderIds),

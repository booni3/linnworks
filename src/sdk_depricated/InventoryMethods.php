...
class InventoryMethods
{
    ...
    {
        return json_decode(Factory::GetResponse("Inventory/GetCountryCodes", array(), $ApiToken, $ApiServer));
    }

    public static function GetCountries($ApiToken, $ApiServer)
    {
        return json_decode(Factory::GetResponse("Inventory/GetCountries", array(), $ApiToken, $ApiServer));
    }
